...
while True:
    ...
    if faceCurFrame:
        ...
        if counter!=0:
            if counter ==1:
                studentInfo=db.reference(f'attendance/{id}').get()
                print(studentInfo)
            ...
            if modeType!=3:
                ...
                if counter<=10:
                    ...
                    cv2.putText(imgBackground,str(studentInfo['total_attendance']),(861,125),cv2.FONT_HERSHEY_COMPLEX,0.5,(255,255,255),1)
                    ...
                    cv2.putText(imgBackground, str(studentInfo['school']), (910, 625), cv2.FONT_HERSHEY_COMPLEX, 0.6,(100, 100, 100), 1)

                    cv2.putText(imgBackground, str(studentInfo['year']), (1025, 625), cv2.FONT_HERSHEY_COMPLEX, 0.6,(100, 100, 100), 1)

                    cv2.putText(imgBackground, str(studentInfo['vaild_till']), (1125, 625), cv2.FONT_HERSHEY_COMPLEX, 0.6,(100, 100, 100), 1)
